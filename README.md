...
> **Beta software:** Version 0.1.3 works on the tested setup, but other Apex Pro generations and layouts may require mapping adjustments.
...
- **A temporary ghost window appears while minimizing:** Update to version 0.1.3-beta or later. Version 0.1.2 still forced an unnecessary taskbar-handle transition.
